...
const Page: React.FC = () => {
  ...
  const contractAddress = "0x01f6ce3402f17f360b253fe0d9a94aa1fb832aacfcba099813657565a271c449";
  const { 
    data: readData, 
    refetch: dataRefetch, 
    isError: readIsError, 
